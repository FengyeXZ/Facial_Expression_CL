...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--wandb_exp', type=str, default='ILProject_exp', help='Wandb experiment Name')

    parser.add_argument('--wandb_project', type=str, default='FinalYearProject', help='Wandb project name')
